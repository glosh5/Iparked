<nav class="sidebar">
    <div class="sidebar-header">
      ...
      <a href="<?php echo e(URL::to('/'.$userURL)); ?>" class="sidebar-brand">
    ...
    <div class="sidebar-body">
      <ul class="nav">
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/users/create')); ?>" class="nav-link">
            <i class="link-icon" data-feather="user-plus"></i>
            <span class="link-title">Add User</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/users')); ?>" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/vehicles')); ?>" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/vehicles/show')); ?>" class="nav-link">
            <i class="link-icon" data-feather="truck"></i>
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/parking/create')); ?>" class="nav-link">
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/parking')); ?>" class="nav-link">
            <i class="link-icon" data-feather="map-pin"></i>
        ...
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/parkedCar')); ?>" class="nav-link">
            <i class="link-icon" data-feather="plus"></i>
            <span class="link-title">Add parked car</span>
          </a>
        </li>
        <li class="nav-item">
          <a href="<?php echo e(URL::to($userURL.'/parkedCar/parkedVehicles')); ?>" class="nav-link">
            <i class="link-icon" data-feather="truck"></i>
  ...
  </nav><?php /**PATH /home/bagloria/public_html/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>